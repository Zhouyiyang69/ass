...
def cross_product(x1, y1, x2, y2, x3, y3):
    # 計算向量 (x2-x1, y2-y1) 和 (x3-x1, y3-y1) 的叉積
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        cp1 = cross_product(x3, y2, *xy1, *xy2)
                        cp2 = cross_product(x3, y2, *xy2, *xy3)
                        cp3 = cross_product(x3, y2, *xy3, *xy4)
                        cp4 = cross_product(x3, y2, *xy4, *xy1)
            ...
            if view_img:
                ...
                cv2.line(im0, xy1, xy2, clr, 4)
                cv2.line(im0, xy2, xy3, clr, 4)
                cv2.line(im0, xy3, (1280,720), clr, 4)
                cv2.line(im0,  (1280,720),xy4, clr, 4)

                cv2.line(im0, xy4, xy1, clr, 4)
